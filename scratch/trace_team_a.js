...
async function run() {
    try {
        console.log("Checking Team A members in 'warga':");
        const [wargas] = await db.query("SELECT id, nama, tim_ronda FROM warga WHERE tim_ronda = 'A'");
        wargas.forEach(w => {
